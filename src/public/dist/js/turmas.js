...
$(document).ready(() => {
    ...
    columns: [
...

      {
        ...
        render: (data) => {
          let html = `
    <div>
      <button class="btn btn-link text-dark p-0 me-2" title="Editar" onclick="editarTurma('${data.id}')">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
      ...
      <button class="btn btn-link text-danger p-0" title="Excluir" onclick="deletarTurma('${data.id}')">
